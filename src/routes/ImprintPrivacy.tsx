...
function ImprintPrivacy() {
  const [showsImprint, setShowsImprint] = useState(false);

  const handleChange = () => {
    setShowsImprint(!showsImprint);
  };
  ...
  return (
    <div className="text-white">
      <div className="mb-5">
        <label
          className="mb-5  h-10 w-3 cursor-pointer rounded-full p-2 "
          htmlFor="showImprint"
        >
          <input
            id="showImprint"
      ...
      {!showsImprint ? (
        <section>
          ...
          <p>
            Telefon: 0152 22804729
            <br />
            E-Mail: sven.oliverpaetzel@gmail.com
          </p>
          <p>
